...
export function AIAssistant({
  ...
  return (
    <>
      ...
      {isOpen ? (
        <aside aria-label={t("ai.panelAriaLabel")} className="kanban-ai-panel">
          <header className="kanban-ai-panel__header">
            ...
            <div className="kanban-ai-panel__actions">
              ...
              <Button
                aria-label={t("ai.closeAriaLabel")}
                onClick={onToggle}
                size="icon-sm"
                type="button"
                variant="ghost"
          ...
          <div className="kanban-ai-panel__messages" ref={messagesContainerRef}>
            ...
            {pendingConfirmation && !isProcessing ? (
              <div className="kanban-ai-confirmation">
                <strong>{t("ai.confirmDeletion")}</strong>
                <p>{pendingConfirmation.message}</p>
                <ul>
                  {pendingConfirmation.itemTitles.map((title) => (
                    <li key={title}>{title}</li>
                  ))}
                </ul>
                {pendingConfirmation.kind === "delete_column" ? (
                  <span>
                    {t("ai.affectedCards", {
                      count: pendingConfirmation.affectedCardCount,
                    })}
                  </span>
                ) : null}
                <div>
