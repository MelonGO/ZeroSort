...
Comprehensive performance optimization guide for React applications. Contains 51 rules across 8 categories, prioritized by impact to guide automated refactoring and code generation.
